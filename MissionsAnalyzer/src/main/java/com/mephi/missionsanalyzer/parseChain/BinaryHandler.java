...
import com.mephi.missionsanalyzer.parsersForEachType.BinaryParser;

/**
 *
 * @author panda
 */
public class BinaryHandler extends BaseParserHandler {
    ...
    protected boolean canParse(String filePath) {
        ...
        if (firstLine.trim().startsWith("MISSION_CREATED|")) {
            return true;
        }
        else {
            return false;
